...
?>
<!-- Form for JToolBarHelper::custom -->
<form action="index.php" id="adminForm" method="post" name="adminForm">
    ...
    <div id="gimenu1">
        ...
        <div class="menuitem">
            <div class="icon" id="import_thm_repo_form_button"
                 onClick="document.getElementById('import_thm_repo_form_file').click();">
                <div class="picture2">
                ...
                <form action="index.php?option=com_thm_repo&task=zipImportAction" method="post"
                      enctype="multipart/form-data" id="import_thm_repo_form" name="import_thm_repo_form"
                      style="display:none;">
                    <input name="import_thm_repo_form_file" id="import_thm_repo_form_file" type="file" size="5000"
                           maxlength="100000" accept="application/zip" class="hide"/>
                </form>
            </div>
        </div>
        <!-- Form for JToolBarHelper::custom -->
