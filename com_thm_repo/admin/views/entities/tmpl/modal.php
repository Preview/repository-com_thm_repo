...
?>
<form
	action="<?php echo JRoute::_('index.php?option=com_thm_repo&view=entities&id=' . (int) $id . '&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken()) ?>"
	...
	<table class="table table-striped table-condensed">
		...
		{ ?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<button name="" type="button" value="Select" onclick="<?php echo "$function({$item->id})"; ?>">
				</td>
